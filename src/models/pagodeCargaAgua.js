...
export const pagoCargaAgua = bd.define('pagos_carga_agua', {
  ...
  cargaAguaIds: { type: DataTypes.ARRAY(DataTypes.INTEGER), allowNull: false }
});
...
pagoCargaAgua.belongsToMany(cargaAgua, { through: 'pago_carga_agua_cargas', foreignKey: 'pagoId', otherKey: 'cargaId', as: 'cargas' });
cargaAgua.belongsToMany(pagoCargaAgua, { through: 'pago_carga_agua_cargas', foreignKey: 'cargaId', otherKey: 'pagoId', as: 'pagos' });
